...
from refiner.atlassian_utils import IssueInfo, JiraClient, parse_atlassian_datetime as _parse_dt
...
def _fetch_confluence_context(
    ...
    *,
    ...
    if not include_conf or not issue_text:
        return ""
    try:
        from refiner.confluence_analysis import get_page_text_by_id as _conf_get_by_id  # lazy import
    except Exception:
