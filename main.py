...
def load_config(path: str = 'config.json') -> dict:
    ...
    a set of safe defaults that mirror the existing hardcoded behaviour.
    ...
    defaults = {
        ...
        # Confluence paging defaults (used by confluence_analysis)
        "confluence": {
            "page_size": 100,
            "max_items": 10000,
    ...
    try:
        with open(path, 'r') as f:
            ...
            # Migration: if 'company' exists but 'instances' does not, migrate it
    ...
    # Final check: if 'instances' is still empty, ensure at least one entry from old 'company' default
